...
execute as @a[scores={job=11},tag=t:sneaking] as @s[scores={recast=..0}] as @s[scores={ac1=1..5}] at @s run tellraw @s {"rawtext":[{"text":"§aダイスロール§r=>§a "},{"score":{"name":"@p","objective":"ac1"}}]}
...
execute as @a[scores={job=11},tag=t:sneaking] as @s[scores={recast=..0}] as @s[scores={ac1=6..95}] at @s run tellraw @s {"rawtext":[{"text":"§aダイスロール§r=> "},{"score":{"name":"@p","objective":"ac1"}}]}
execute as @a[scores={job=11},tag=t:sneaking] as @s[scores={recast=..0}] as @s[scores={ac1=6..95}] at @s run playsound random.orb @s ~~~ 1 1
execute as @a[scores={job=11},tag=t:sneaking] as @s[scores={recast=..0}] as @s[scores={ac1=96..100}] at @s run tellraw @s {"rawtext":[{"text":"§aダイスロール§r=>§c "},{"score":{"name":"@p","objective":"ac1"}}]}
...
execute as @a[scores={job=11},tag=t:sneaking] as @s[scores={recast=..0}] as @s[scores={ac1=51..75}] as @s[scores={skilllevel=1}] at @s run scoreboard players add @s ap 5
execute as @a[scores={job=11},tag=t:sneaking] as @s[scores={recast=..0}] as @s[scores={ac1=51..75}] as @s[scores={skilllevel=2}] at @s run scoreboard players add @s ap 10
execute as @a[scores={job=11},tag=t:sneaking] as @s[scores={recast=..0}] as @s[scores={ac1=51..75}] as @s[scores={skilllevel=3}] at @s run scoreboard players add @s ap 15
