...
execute as @a[scores={recast=1..}] as @a[scores={reload=1..}] at @s run titleraw @s actionbar {"rawtext":[{"text":"§9リキャスト§r: "},{"score":{"name":"@p","objective":"recast"}},{"text":"秒§r\\n"},{"text":"§6リロード§r: "},{"score":{"name":"@p","objective":"reload"}}]}
...
execute as @a[scores={recast=..0}] as @a[scores={reload=1..}] at @s run titleraw @s actionbar {"rawtext":[{"text":"§9リキャスト§r: §a準備完了"},{"text":"\\n§6リロード§r: "},{"score":{"name":"@p","objective":"reload"}}]}
