...
execute as @a[scores={parkcountdown=6}] at @s run tellraw @s { "rawtext": [{"text":"§6続いて、パークを選んでください。"}] }
execute as @a[scores={parkcountdown=6}] at @s run playsound note.pling @s ~~~ 1 1
