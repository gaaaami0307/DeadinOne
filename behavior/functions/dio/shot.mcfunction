...
execute as @a[tag=assault_shot,scores={arrow=..0}] at @s positioned ^^^0.5 run tag @s add wantreload
...
execute as @a[tag=minigun_shot,scores={arrow=..0}] at @s positioned ^^^0.5 run tag @s add wantreload
...
execute as @a[tag=handgun_shot,scores={arrow=..0}] at @s positioned ^^^0.5 run tag @s add wantreload
