...
execute as @a[tag=battle] at @s run scoreboard players add @s[tag=!t:moving] count_stop 1
scoreboard players set @a[tag=t:moving] count_stop 0
execute as @a[tag=battle] at @s run scoreboard players add @s[tag=t:moving] count_move 1
